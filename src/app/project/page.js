...
import { FolderPlus, ArrowLeft, Sparkles, Tags, Users, Calendar, FileText  ,History as HistoryIcon, Loader2} from "lucide-react";
...
export default function CreateProject() {
  ...
  const { user,setSave,project ,setProject } = useContext(ResultsContext);
